...
# wget the 2016-11-14 release
RUN wget -O pytivo.tar.gz http://repo.or.cz/pyTivo/wmcbrine/lucasnz.git/snapshot/fed77397491e1dc1ffb0fc400998542a5eec8866.tar.gz
